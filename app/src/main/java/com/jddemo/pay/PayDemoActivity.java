...
//	private static final String URL_JSON = "http://169.254.63.148:8080/alipayServer/AlipayDemo";
    ...
    TextView product_subject,goods_ms,product_price;
    Intent datai;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product_subject=findViewById(R.id.product_subject);
        goods_ms=findViewById(R.id.goods_ms);
        product_price=findViewById(R.id.product_price);

        datai=getIntent();

        product_price.setText(datai.getStringExtra("price"));
        goods_ms.setText(datai.getStringExtra("title"));
        product_subject.setText("测试商品");
        /**
    ...
    private void paySignFromClient() {
        //获得订单信息
        String orderInfo = getOrderInfo("来自Client测试商品",datai.getStringExtra("title"), "0.01");
        //进行加密签名
